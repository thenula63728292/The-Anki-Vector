...
PM_START_TEXT = """
Hello there, I'm [Mizu](https://telegra.ph/file/b9844274494fcde4e0589.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➕ Add Dofini to your group ➕", url="http://t.me/TheMizubot?startgroup=true"
        ),
    ],
]
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [MizuUpdates](https://t.me/MizuUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
